...
public abstract class GeneratedExample<T> extends ClassTypeAdapt {
    ...
    public GeneratedExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    public GeneratedExample setOrderByClause(String orderByClause) {
    ...
    public GeneratedExample setDistinct(boolean distinct) {
