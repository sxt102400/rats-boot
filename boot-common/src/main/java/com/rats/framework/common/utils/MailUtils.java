package com.rats.framework.common.utils;
...
public class MailUtils {
    ...
    public MailUtils(String to, String from, String host, String username,
    ...
    public MailUtils(String host, String from, String username,
                     String password) {
    	this.host = host;
    	this.from = from;  
        this.username = username;  
