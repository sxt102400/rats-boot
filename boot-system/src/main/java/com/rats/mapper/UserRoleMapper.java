...
public interface UserRoleMapper {
     ...
     */
    List<UserRole> selectByExample(GeneratedExample example);
     ...
     * @return int 更新记录数
     */
    int updateByExampleSelective(@Param("record") UserRole record, @Param("example") GeneratedExample example);
     ...
     * @return int 更新记录数
     */
    int updateByExample(@Param("record") UserRole record, @Param("example") GeneratedExample example);
     ...
     * @return List<UserRole>t_sys_user_role结果集
     */
    List<UserRole> selectByExample(GeneratedExample example, RowBounds rowBounds);
